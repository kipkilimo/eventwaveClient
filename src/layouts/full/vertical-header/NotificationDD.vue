...
const eventData = {
  data: {
    eventBySecret: {
      id: "6929f386573cfa24a00132cc",
      title: "Taifa Care Training Samia and Bunyala",
      description:
        "Taifa Care training refers to educational programs for healthcare workers on the TaifaCare system, a rebranded version of KenyaEMR that is central to Kenya's goal of achieving Universal Health Coverage (UHC). Training sessions cover topics like using the system for patient registration, managing stock and pharmacy dispensing, and understanding new features like enhanced surveillance dashboards. The training also includes sensitizing staff on the system's digital health agenda and providing guidance on facility upgrades.",
      eventSecret: "HDFYVQ",
      eventType: "TRAINING",
      isRecurring: false,
      status: "PUBLISHED",
      createdAt: "2025-11-28T19:09:58.882Z",
      updatedAt: "2025-11-28T19:09:58.882Z",
      durationHours: null,
      isActive: null,
      isRegistrationOpen: null,
      organizer: {
        id: "6929e2cc573cfa24a00132a0",
        name: "Camilita Apondi",
        email: "cafenetpoint2016@gmail.com",
      },
      organization: null,
      facilitators: [
        {
      ...
      participants: [],
      dateTime: {
        start: "2025-12-02T05:00:00.000Z",
        end: "2025-12-02T17:00:00.000Z",
      },
      location: {
        name: "Acacia Resort, Hakati",
        address: "Simba Hall",
        virtualLink: "",
        isVirtual: false,
      },
